...
public enum CacheEnums {
    ...
    M_N_U("m_n_u","模型节点 of uid", "流程名称+分隔符+版本+分隔符+模型节点uid", "m_n_u+分隔符+流程名称+分隔符+版本+分隔符+模型节点uid"),
    M_N_N("m_n_n", "模型节点 of  num", "流程名称+分隔符+版本+分隔符+模型节点位置", "m_n_n+分隔符+流程名称+分隔符+版本+分隔符+模型节点位置"),
